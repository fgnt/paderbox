...
class test_wsj_db(db_test.DatabaseTest):
    ...
    def test_official_len(self):
        self.assertEqual(
            len(self.json['train']['flists']['wave']['official_si_284']), 37416,
            'Warning: expected 37416 lines in official_si_284.flist')
        self.assertEqual(
            len(self.json['train']['flists']['wave']['official_si_84']), 7138,
            'Warning: expected 7138 lines in official_si_84.flist')
        self.assertEqual(
            len(self.json['test']['flists']['wave']['official_si_et_20']), 333,
            'Warning: expected 333 lines in official_si_et_20.flist')
        self.assertEqual(
            len(self.json['test']['flists']['wave']['official_si_et_05']), 330,
        ...
        self.assertEqual(
            len(self.json['test']['flists']['wave']['official_si_et_h2/wsj5k']),
            215,
            'Warning: expected 213 lines in official_si_et_h2/wsj5k.flist')  # Should be 213 not 215 links!
        self.assertEqual(
            len(self.json['dev']['flists']['wave']['official_si_dt_20']), 503,
            'Warning: expected 503 lines in official_si_dt_20flist')
        self.assertEqual(
            len(self.json['dev']['flists']['wave']['official_si_dt_05']), 513,
            'Warning: expected 513 lines in official_si_dt_05.flist')
        self.assertEqual(
            len(self.json['dev']['flists']['wave']['official_Dev-set_Hub_1']),
            503,
            'Warning: expected 503 lines in Dev-set_Hub_1.flist')
        self.assertEqual(
            len(self.json['dev']['flists']['wave']['official_Dev-set_Hub_2']),
            913,
