...
def bark_fbank(time_signal, sample_rate=16000, window_length=400, stft_shift=160,
    ...
    filterbanks = get_bark_filterbanks(nfft=stft_size, sample_rate=sample_rate, number_of_filters=number_of_filters,
...
def get_bark_filterbanks(nfft, sample_rate=16000, number_of_filters=23, width=1, lowest_frequency=0,
	...
	:param number_of_filters: number of output bands required (default one per bark -> 23)
